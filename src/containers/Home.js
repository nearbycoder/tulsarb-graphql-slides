...
`}
        ...
        <Slide transition="cross-fade" bgColor="#1D1F27">
          <Center>
            <H3 color="rgb(219, 112, 147)">
              Simply describe what you want back from the server in the same
...
`}
        ...
        <Slide transition="cross-fade" bgColor="#1D1F27">
          <Center>
            <H3 color="#DA9962">What about changing data?</H3>
          </Center>
        </Slide>
        <Slide transition="cross-fade" bgColor="#1D1F27">
          <Center>
            <H3 color="rgb(219, 112, 147)">
              In GraphQL this is called a Mutation
            </H3>
          </Center>
        </Slide>
        <Slide transition="cross-fade" bgColor="#1D1F27">
          <Center>
            <SyntaxHighlighter
              ...
              {`
mutation { 
  updateUser(id: 1, user: {email: "test@gmail.com"}) {
    id
    firstName
    email
  }
...
`}
        ...
        <Slide transition="cross-fade" bgColor="#1D1F27">
          <Center>
            <H3 color="#DA9962">Awesome Resources</H3>
            <H4 color="rgb(219, 112, 147)" left>
              <a
                target="_blank"
                style={{ color: 'rgb(219, 112, 147)' }}
                href="https://github.com/rmosolgo/graphql-ruby">
